...
def increment_hex_string(hex_str):
...
with open(file_path, 'a') as file:
    # Increment the string and write results to the file indefinitely
    hex_str = last_key
    while True:
        hex_str = increment_hex_string(hex_str)
        file.write(hex_str + '\n')
